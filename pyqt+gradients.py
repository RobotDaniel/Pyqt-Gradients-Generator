...
layout.addWidget(slidergreenleft,3,0)
layout.addWidget(labelgreemleft,4,0)
layout.addWidget(sliderblueleft,5,0)
layout.addWidget(labelblueleft,6,0)

layout.addWidget(rightlabel,0,1)
layout.addWidget(sliderredright,1,1)
layout.addWidget(labelredright,2,1)
layout.addWidget(slidergreenright,3,1)
layout.addWidget(labelgreemright,4,1)
layout.addWidget(sliderblueright,5,1)
